...
/**
 * In order to make the class be field injected by Hilt, we have to:
 *
 *  - Annotate the ButtonsFragment with @AndroidEntryPoint,
 *  - Remove private modifier from logger and navigator fields and annotate them with @Inject
 */
@AndroidEntryPoint
class ButtonsFragment : Fragment() {
    ...
    /**
     *  The instance of AppNavigator will be different from the instance in MainActivity
     *  as we haven't scoped it to its respective Activity container.
     */
    @Inject
