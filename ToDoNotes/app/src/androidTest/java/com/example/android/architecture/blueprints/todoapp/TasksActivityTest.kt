...
class TasksActivityTest {
    ...
    fun createOneTask_deleteTask() {
        ...
        onView(withId(R.id.add_task_title_edit_text)).perform(replaceText("Task_1"))
        onView(withId(R.id.add_task_description_edit_text)).perform(replaceText("Description_1"))
        onView(withId(R.id.save_task_fab)).perform(click())
        // 3. Open the new task in a details view.
        onView(withText("Task_1")).perform(click())
        // 4. Click delete task in menu.
        onView(withId(R.id.menu_delete)).perform(click())
        // 5. Verify it was deleted.
        onView(withText("Task_1")).check(doesNotExist())
