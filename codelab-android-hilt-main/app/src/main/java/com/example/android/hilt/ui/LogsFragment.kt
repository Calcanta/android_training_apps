...
/**
 * Annotating Android classes with @AndroidEntryPoint
 * creates a dependencies container that follows the Android class lifecycle.
 */

@AndroidEntryPoint
class LogsFragment : Fragment() {
   // We can make Hilt inject instances of different types with the @Inject annotation on the fields we want to be inject
