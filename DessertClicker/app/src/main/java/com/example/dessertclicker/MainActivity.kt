...
fun DessertClickerApp(
    ...
    val uiState by viewModel.dessertUiData.collectAsState()
    DessertClickerApp(
        uiState = uiState,
        ...
        Column {
            Box(
                ...
                Image(
                    ...
                    contentDescription = "dessert_button",
                    modifier = Modifier
...
fun MyDessertClickerAppPreview() {
    DessertClickerTheme {
        DessertClickerApp(uiState = DessertUiData(), onDessertClicked = {})
    }
}
